module.exports = {
    ...
    run: async (client, message, args) => {
        const embed = new Discord.MessageEmbed()
            ...
            .addFields({
                name: 'statusprzerwa',
                value: 'Ustawia botowi status przerwy technicznej'
            },
            {
                name: 'statushelp',
                value: 'Pokazuje na statusie bota polecenie z wszystkimi komendami bota',
                inline: true
            },
            {
                name: 'skod',
                value: 'Pokazuje status "Kod Źródłowy"',
                inline: true
            })
            .setTimestamp()
